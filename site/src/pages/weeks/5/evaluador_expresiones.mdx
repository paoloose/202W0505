...
Su algoritmo debe leer la expresión token por token, utilizando una pila para almacenar operadores. (Ya no necesita la pila de valores del estudio de caso original). En su lugar, cada vez que encuentre un número, agréguelo a una cadena que esté creando. Cada vez que encuentre un paréntesis derecho, abra la pila para obtener un operador y agréguelo a la cadena que está creando. Deje el resto del código en su lugar para preservar la verificación de errores. Devuelva la cadena "expresión ilegal" si se encuentra un error.
  ...
  <Snippet key: 'tab-3', label: 'Rust', lang: 'rust', file='evaluador_expresiones/src/main.rs', line_start:6 line_end:14 />
  ...
  <Snippet key: 'tab-3', label: 'Rust', lang: 'rust', file='evaluador_expresiones/src/main.rs', line_start:54 line_end:56 />
  ...
  <Snippet key: 'tab-3', label: 'Rust', lang: 'rust', file='evaluador_expresiones/src/main.rs', line_start:16 line_end:23 />
  ...
  <Snippet key: 'tab-3', label: 'Rust', lang: 'rust', file='evaluador_expresiones/src/main.rs', line_start:25 line_end:34 />
  ...
  <Snippet key: 'tab-3', label: 'Rust', lang: 'rust', file='evaluador_expresiones/src/infija_to_postfija/postfija', line_start:4 line_end:37 />
  ...
  <Snippet key: 'tab-3', label: 'Rust', lang: 'rust', file='evaluador_expresiones/src/main.rs', line_start:35 line_end:37 />
  <Snippet key: 'tab-3', label: 'Rust', lang: 'rust', file='evaluador_expresiones/src/infija_to_postfija/postfija', line_start:39 line_end:45 />
